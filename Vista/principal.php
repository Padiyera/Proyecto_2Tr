                                ...
                                <tr v-for="(vehiculo, indice) of vehiculos" :key="indice">
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            ...
                                            <button v-if="vehiculo.estado === 'En deposito'" class="btn btn-warning" title="Retirar" @click="btnRetirar(vehiculo.id, vehiculo.matricula, vehiculo.agente, vehiculo.tipovehiculo)"><i class="fas fa-sign-out-alt"></i></button>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
